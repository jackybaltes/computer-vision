...
# 22nd December 2022 - 23:59

## Updates

1) Page opened 8th December 2022

## Introduction

The goal of this assignment is to develop a magic trick that can be performed
via the Internet.

A user draws one of the [Zener symbols](https://en.wikipedia.org/wiki/Zener_cards)
on a notepad. The Zener symbols include circle, plus, wave, square, and star.

The computer correctly predicts the drawn symbol and then verifies it 
by having the user show the drawn symbol to the screen.

A video showing the magic trick is shown below.
